 ...
 merndeveloperjunior?.map((item, index) => {
  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="piechart-details">
          <div className="test-legend">
            ...
            <span className="test">Python</span>
            </div>
           <div>
           <button
           ...
           <button
              ...
              className="color"
            ></button>
            <span className="test">FullStack</span>
            </div>   
          </div>
          <div className="test-legend">
          <div>
           ...
           <button
            ...
            ></button>
             <span className="test">Frontend Fresher </span>
           </div>
           <div>
           <button
              className="color"
            ...
            ></button>
            <span className="test">Freshers Junior</span>
           </div>
          ...
          <div>
           <button
            ...
            ></button>
            <span className="test">Freshers</span>
           </div>
           <div>
           <button
              className="color"
            ...
            ></button>
            <span className="test">MERN Developer Intermediate</span>
           </div>
           <div> <button
              className="color"
              style={{ backgroundColor: "#b02709" }}
            ></button>
            <span className="test">MERN Developer Junior</span></div>
            <div>
            <button
              className="color"
              style={{ backgroundColor: "#102061" }}
            ></button>
            <span className="test">Shopify Developer</span>
            </div>
           <div>
           </div>
           <div>
      ...
      <div className="piechart-detailsof-each-section">
        <div className="test-legend-each-section">
          <div>
          <button
            className="color"
      ...
      <div className="dashboard_chart_container">
        <Chart
          ...
          options={{
            ...
            title: `Fresher Test Metrics ${fresher.length===0 ? ": 0 Test Taken":""}`,
        ...
        <Chart
          ...
          options={{
            title: "",
            title: `Python Test Metrics${python.length===0 ? ": 0 Test Taken":""}`,
            colors: ["#111359", "#afd25f"],
            legend: "none",
          }}
        />  
        <Chart
          ...
          options={{
            title: `FullStack Test Metrics ${fullStack.length===0 ? ":0 Test Taken":""}`,
            colors: ["#e37412", "#38b55e"],
            legend: "none",
          }}
        ...
        <Chart
          ...
          data={javaPieData}
          options={{
            title: `Java Test Metrics ${java.length===0 ? ": 0 Test Taken":""}`,
            colors: ["#111359", "#afd25f"],
            legend: "none",
          }}
        />
        <Chart
          ...
          options={{
            ...
            title: `QA Test Metrics ${qa.length===0 ? ": 0 Test Taken":""}`,
            colors: ["#111359", "#afd25f"],
            legend: "none",
          }}
        />
        <Chart
          ...
          options={{
            ...
            title: `Froent end Fresher Test Metrics ${frontendfresher.length===0 ? ": 0 Test Taken":""}`,
            colors: ["#111359", "#afd25f"],
              legend: "none",
          }}
        />
        ...
        <Chart
          ...
          options={{
            title: `FresherJunior Test Metrics ${freshersJunior.length===0 ? ": 0 Test Taken":""}`,
            colors: ["#111359", "#8f0f91"],
            legend: "none",
          }}
        />
        <Chart
          ...
          options={{
            title: "",
            title: `MernDeveloper Junior Test Metrics ${merndeveloperjunior.length===0 ? ": 0 Test Taken":""}`,
            colors: ["#111359", "#afd25f"],
             legend: "none",
          }}
        />
        <Chart
          ...
          options={{
            ...
            title: `MernDeveloperIntermediate Test Metrics ${merndeveloperintermediate.length===0 ? ": 0 Test Taken": ""}`,
            colors: ["#111359", "#afd25f"],
            legend: "none",
          }}
        />
        <Chart
          ...
          data={shopifyPieData}
          options={{
            title: `Shopify Test Metrics ${shopify.length===0 ? ": 0 Test Taken":""}`,
            colors: ["#111359", "#afd25f"],
            legend: "none",
          }}
        />
